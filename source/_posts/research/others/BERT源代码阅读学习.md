...
<img src="./BERT源代码阅读学习.assets/image-20220711105616573.png" alt="image-20220711105616573" style="zoom:50%;" />

#### 1.1.2 Multi-Head Self Attention

![image-20220711105642016](./BERT源代码阅读学习.assets.assets/image-20220711105642016.png)

#### 1.1.3 BERT Embedding

这个是bert模型结构的embedding输入，也需要联合代码看一下这个过程是怎么实现的。

![image-20220711110109758](./BERT源代码阅读学习.assets/image-20220711110109758.png)



这里补充贴一张LUKE的图，虽然没看过但是看起来加了一个Entity Type Embedding，好像还是个比较有名的工作

![image-20220712195033334](./BERT源代码阅读学习.assets/image-20220712195033334.png)
...
![image-20220711135726421](./BERT源代码阅读学习.assets/image-20220711135726421.png)
...
![image-20220713092751251](./BERT源代码阅读学习.assets/image-20220713092751251.png)
...
![image-20220713165208863](./BERT源代码阅读学习.assets/image-20220713165208863.png)
...
![image-20220713170145685](./BERT源代码阅读学习.assets/image-20220713170145685.png)
...
<img src="./BERT源代码阅读学习.assets/image-20220712110214629.png" alt="image-20220712110214629" style="zoom:50%;" />
...
<img src="./BERT源代码阅读学习.assets/image-20220712093703201.png" alt="image-20220712093703201" style="zoom:50%;" />
...
![image-20220711141124709](./BERT源代码阅读学习.assets/image-20220711141124709.png)
...
- `output_attentions`
  ...
  ![image-20220711172228802](./BERT源代码阅读学习.assets/image-20220711172228802.png)
...
- `hidden_states`
  ...
  ![image-20220711173534108](./BERT源代码阅读学习.assets/image-20220711173534108.png)
...
- 首先加载config.json
  ...
  <img src="./BERT源代码阅读学习.assets/image-20220711232228890.png" alt="image-20220711232228890" style="zoom:50%;" />

- 其次加载pytorch_model.bin文件

  通过在`config_path`目录下寻找文件，命中了`pytorch_model.bin`这个pytorch的checkpoint文件

  ![image-20220711224750910](./BERT源代码阅读学习.assets/image-20220711224750910.png)
  ...
  ![image-20220711233904281](./BERT源代码阅读学习.assets/image-20220711233904281.png)
...
![image-20220712001457966](./BERT源代码阅读学习.assets/image-20220712001457966.png)

![image-20220712001307673](./BERT源代码阅读学习.assets/image-20220712001307673.png)
...
![image-20220711141742912](./BERT源代码阅读学习.assets/image-20220711141742912.png)

这里如果再次尝试加载空模型的时候，因为参数是随机初始化的，所以参数初始化结果可能有所不同，如下图所示

![image-20220711142519040](./BERT源代码阅读学习.assets/image-20220711142519040.png)
...
![image-20220712122136461](./BERT源代码阅读学习.assets/image-20220712122136461.png)
...
![image-20220712123154538](./BERT源代码阅读学习.assets/image-20220712123154538.png)

## 3. Transformer&BERT论文阅读中的重点记录

### 3.1 Attention is all you need

![image-20220712214108979](./BERT源代码阅读学习.assets/image-20220712214108979.png)

![image-20220712214133925](./BERT源代码阅读学习.assets/image-20220712214133925.png)

![image-20220712214114211](./BERT源代码阅读学习.assets/image-20220712214114211.png)

<img src="./BERT源代码阅读学习.assets/image-20220712214155672.png" alt="image-20220712214155672" style="zoom:50%;" />
